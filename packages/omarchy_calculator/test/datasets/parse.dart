...
final parseDataSet = [
  (
    ...
    <(List<Token>, Expression)>[
      ...
      ([NumberToken('0')], NumberExpression(Decimal.fromInt(0))),
      ([NumberToken('1')], NumberExpression(Decimal.fromInt(1))),
      ([NumberToken('999')], NumberExpression(Decimal.fromInt(999))),
      ...
      ([NumberToken('3.14159')], NumberExpression(Decimal.parse('3.14159'))),
      ([NumberToken('2.71828')], NumberExpression(Decimal.parse('2.71828'))),
      ([NumberToken('5')], NumberExpression(Decimal.fromInt(5))),
      ([NumberToken('10')], NumberExpression(Decimal.fromInt(10))),
      ([NumberToken('50')], NumberExpression(Decimal.fromInt(50))),
      ([NumberToken('101')], NumberExpression(Decimal.fromInt(101))),
      ([NumberToken('500')], NumberExpression(Decimal.fromInt(500))),
      ([NumberToken('1001')], NumberExpression(Decimal.fromInt(1001))),
      ([NumberToken('9999')], NumberExpression(Decimal.fromInt(9999))),
      ([NumberToken('0.5')], NumberExpression(Decimal.parse('0.5'))),
      ([NumberToken('0.25')], NumberExpression(Decimal.parse('0.25'))),
      ([NumberToken('0.75')], NumberExpression(Decimal.parse('0.75'))),
      ([NumberToken('1.5')], NumberExpression(Decimal.parse('1.5'))),
      ([NumberToken('2.5')], NumberExpression(Decimal.parse('2.5'))),
      ([NumberToken('12.5')], NumberExpression(Decimal.parse('12.5'))),
      ([NumberToken('99.9')], NumberExpression(Decimal.parse('99.9'))),
      ([NumberToken('0.99')], NumberExpression(Decimal.parse('0.99'))),
      ([NumberToken('0.01')], NumberExpression(Decimal.parse('0.01'))),
      ([NumberToken('7.77')], NumberExpression(Decimal.parse('7.77'))),
      ([NumberToken('8.88')], NumberExpression(Decimal.parse('8.88'))),
      ([NumberToken('11.11')], NumberExpression(Decimal.parse('11.11'))),
    ],
  ),
  (
    'Binary operations',
    <(List<Token>, Expression)>[
      ...
      (
        ...
        BinaryExpression(
          BinaryOperator.add,
          NumberExpression(Decimal.parse('15.5')),
          NumberExpression(Decimal.parse('24.3')),
        ),
      ),
      (
        <Token>[
      ...
      (
        ...
        BinaryExpression(
          BinaryOperator.subtract,
          NumberExpression(Decimal.parse('7.8')),
          NumberExpression(Decimal.parse('2.3')),
        ),
      ),
      (
        <Token>[
      ...
      (
        ...
        BinaryExpression(
          ...
          NumberExpression(Decimal.parse('2.2')),
        ),
      ),
      (
        <Token>[
        ...
        BinaryExpression(
          BinaryOperator.divide,
          NumberExpression(Decimal.fromInt(36)),
          NumberExpression(Decimal.fromInt(6)),
        ),
      ),
      (
        ...
        BinaryExpression(
          BinaryOperator.divide,
          NumberExpression(Decimal.parse('15.6')),
      ...
      (
        ...
        BinaryExpression(
          BinaryOperator.power,
          NumberExpression(Decimal.parse('1.5')),
          NumberExpression(Decimal.fromInt(3)),
        ),
      ),
      (
      ...
      (
        ...
        BinaryExpression(
          BinaryOperator.subtract,
          NumberExpression(Decimal.parse('1.25')),
          NumberExpression(Decimal.parse('0.25')),
        ),
      ),
      (
        <Token>[
      ...
      (
        ...
        BinaryExpression(
          BinaryOperator.divide,
          NumberExpression(Decimal.fromInt(144)),
          NumberExpression(Decimal.fromInt(12)),
        ),
      ),
      (
  ...
  (
    ...
    <(List<Token>, Expression)>[
      ...
      (
        <Token>[NumberToken('144'), FunctionToken(MathFunction.squareRoot)],
        FunctionExpression(
          MathFunction.squareRoot,
          NumberExpression(Decimal.fromInt(144)),
        ),
      ...
      (
        <Token>[NumberToken('100'), FunctionToken(MathFunction.square)],
        FunctionExpression(
          MathFunction.square,
          NumberExpression(Decimal.fromInt(100)),
        ),
      ...
      (
        <Token>[NumberToken('180'), FunctionToken(MathFunction.sin)],
        FunctionExpression(
          MathFunction.sin,
          NumberExpression(Decimal.fromInt(180)),
        ),
      ),
      (
        <Token>[NumberToken('120'), FunctionToken(MathFunction.cos)],
        FunctionExpression(
          MathFunction.cos,
          NumberExpression(Decimal.fromInt(120)),
        ),
      ),
      (
        <Token>[NumberToken('60'), FunctionToken(MathFunction.tan)],
        FunctionExpression(
          MathFunction.tan,
          NumberExpression(Decimal.fromInt(60)),
        ),
      ...
      (
        <Token>[NumberToken('20'), FunctionToken(MathFunction.percent)],
        FunctionExpression(
          MathFunction.percent,
          NumberExpression(Decimal.fromInt(20)),
        ),
